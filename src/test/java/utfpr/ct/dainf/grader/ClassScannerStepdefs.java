...
public class ClassScannerStepdefs {
    ...
    public void evaluateThrowing(String expression, String exceptionName, String var) throws Throwable {
        ...
        assertEquals(t.getClass().getName(), exceptionName, String.format("Expression '%s' does not throw '%s'", expression, exceptionName));
        Reporter.log(String.format("Expression '%s' throws '%s'", expression, exceptionName), true);
    }
    ...
    public void methodReturnsType(String methodVar, String typeName) throws Throwable {
        ...
        assertEquals(retType.getName(), typeName,
            String.format("Method '%s' does not return '%s'", methodVar, typeName));
        Reporter.log(String.format("Method '%s' returns '%s'", methodVar, typeName), true);
    }
